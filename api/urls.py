...
from core.views import CertificadoDetailView, CreateNewCriminalRecords, CriminalRecordListView, DashboardStatsAPIView, GerarCertificadoView, GetUserPermission, RecordDetailsByReference, RecordStatsView, SolicitarRegistoListCreateView, SolicitarRegistoDetailView, TodasSolicitacoes, get_cidadao_registos, verificar_certificado
...
urlpatterns = [
    ...
    path('records/certificate/', RecordDetailsByReference.as_view(), name='numero_referencia'), # Pegar certificado
    ...
    path('verificar_certificado/<int:cidadao_id>/verif_certificado/', verificar_certificado, name='certificado'),
]
